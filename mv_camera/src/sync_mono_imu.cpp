...
int main(int argc, char **argv)
{
    ...
    std::string pub_time_topic_name = "/sync/gpio_time";
    std::string pub_mono_image_topic_name = "/sync/image_rect";
    ...
    ros::Subscriber sub_time = 
            nh.subscribe(sub_time_topic_name, 5, gpio_time_callback);
    image_transport::Subscriber sub_mono_image = 
            it.subscribe(sub_mono_image_topic_name, 5, mono_image_callback);
