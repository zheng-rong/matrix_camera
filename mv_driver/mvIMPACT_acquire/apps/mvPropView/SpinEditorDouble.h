...
#	endif
#endif
			void						ConfigureControlsCreation( bool boCreateSlider ) { m_boCreateSlider = boCreateSlider; }
	virtual bool						CopyValueFromControl( wxPGProperty* pProperty, wxWindow* pWnd ) const;
	virtual wxPG_CONST_WXCHAR_PTR		GetName( void ) const { return wxT("PGCustomSpinCtrlEditor"); }
#ifndef SWIG
