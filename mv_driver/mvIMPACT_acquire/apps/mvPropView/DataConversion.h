...
public:
	...
	mvIMPACT::acquire::TComponentVisibility GetComponentVisibility( void ) const { return componentVisibility_; }
	void SetComponentVisibility( mvIMPACT::acquire::TComponentVisibility componentVisibility ) { componentVisibility_ = componentVisibility; }

	void ConfigureComponentVisibilitySupport( bool boIsSupported ) { boComponentVisibilitySupported_ = boIsSupported; }
	bool IsComponentVisibilitySupported( void ) const { return boComponentVisibilitySupported_; }
