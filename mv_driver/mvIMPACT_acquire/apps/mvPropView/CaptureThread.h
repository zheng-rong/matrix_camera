...
//------------------------------------------------------------------------------
{
	...
	int											InternalSetLiveMode( bool boOn, bool boInformUserOnRecordStart = true );
	int											InternalSetRecordMode( bool boOn, bool boUnlockCurrentRequest );
...
public:
	...
	int											GetCaptureQueueDepth( void ) const { return m_captureQueueDepth; }
	bool										GetContinuousRecording( void ) const { return m_boContinuousRecording; }
	size_t										GetCurrentSequenceIndex( void ) const { return m_currentSequenceIndexToDisplay; }
	...
	bool										GetLiveMode( void ) const { return m_boLive; }
	size_t										GetMultiFrameSequenceSize( void ) const { return m_maxNumberToRequest; }
	const RequestContainer&						GetRecordedSequence( void ) const { return m_recordedSequence; }
	bool										GetRecordMode( void ) const { return m_boRecord; }
	size_t										GetRecordSequenceSize( void ) const { return m_totalCountToRecord; }
	...
	int											SetLiveMode( bool boOn, bool boInformUserOnRecordStart = true );
	void										SetMultiFrameSequenceSize( size_t sequenceSize );
	int											SetRecordMode( bool boOn );
