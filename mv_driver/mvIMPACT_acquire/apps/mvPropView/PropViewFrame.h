...
DECLARE_EVENT_TYPE( sequenceReadyEvent, -5 )
DECLARE_EVENT_TYPE( imageInfoEvent, -6 )
DECLARE_EVENT_TYPE( refreshAOIControls, -7 )
DECLARE_EVENT_TYPE( refreshCurrentPixelData, -8 )
DECLARE_EVENT_TYPE( imageCanvasSelected, -9 )
DECLARE_EVENT_TYPE( imageCanvasFullScreen, -10 )
DECLARE_EVENT_TYPE( monitorImageClosed, -11 )
DECLARE_EVENT_TYPE( featureChangedCallbackReceived, -12 )
DECLARE_EVENT_TYPE( imageTimeoutEvent, -13 )
...
#ifdef _WIN32
    void                                CreateLogZipFile( wxArrayString logFilesArray, wxString logFileDirectoryPath,  wxString targetFullPath );
#endif //_WIN32
