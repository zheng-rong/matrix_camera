...
public:
	explicit PropViewFrame( const wxString& title, const wxPoint& pos, const wxSize& size, int argc, wxChar** argv );
			~PropViewFrame();
	bool DetailedInfosOnCallback( void ) const { return m_pMISettings_Analysis_DetailedInfoOnCallback->IsChecked(); }
	...
	void WriteErrorMessage( const wxString& msg ) { WriteLogMessage( msg, m_errorStyle ); }
	void WriteLogMessage( const wxString& msg, const wxTextAttr& style = wxTextAttr(*wxBLACK) ) { WriteToTextCtrl( m_pLogWindow, msg, style ); }
protected:
	virtual void AppendCustomPropGridExecutionErrorMessage( wxString& msg ) const;
	virtual bool FeatureChangedCallbacksSupported( void ) const { return true; }
	virtual bool FeatureHasChangedCallback( mvIMPACT::acquire::Component c ) const { return m_pPropViewCallback->isComponentRegistered( c ); }
	virtual EDisplayFlags GetDisplayFlags( void ) const { return m_pDevPropHandler ? m_pDevPropHandler->GetDisplayFlags() : dfNone; }
	// event handlers (these functions should _not_ be virtual)
	void OnAction_DefaultDeviceInterface_Changed( wxCommandEvent& e );
	void OnAction_DisplayConnectedDevicesOnly( wxCommandEvent& )     { UpdateDeviceComboBox(); }
	void OnActivateDisplay( wxCommandEvent& e );
	void OnBtnAbort( wxCommandEvent& ) { Abort(); }
	void OnBtnUnlock( wxCommandEvent& e );
	void OnBtnAcquire( wxCommandEvent& ) { Acquire(); }
	void OnBtnRecord( wxCommandEvent& e );
	void OnIncDecRecordDisplay( wxCommandEvent& e );
	void OnUseDevice( wxCommandEvent& ) { ToggleCurrentDevice(); }
	...
	void OnDevComboTextChanged( wxCommandEvent& )                    { UpdateDeviceFromComboBox(); }
	void OnEventNotified( wxCommandEvent& e );
	void OnExportActiveDevice( wxCommandEvent& e );
	void OnAction_Exit( wxCommandEvent& ) { Close( true ); }
	void OnAnalysisPlotAOIhChanged( wxSpinEvent& e )                 { UpdateAnalysisPlotAOIParameter( m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas, -1, -1, -1, e.GetPosition() ); }
	void OnAnalysisPlotAOIhTextChanged( wxCommandEvent& e )          { UpdateAnalysisPlotAOIParameter( m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas, -1, -1, -1, e.GetInt() ); }
	void OnAnalysisPlotAOIwChanged( wxSpinEvent& e )                 { UpdateAnalysisPlotAOIParameter( m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas, -1, -1, e.GetPosition() ); }
	void OnAnalysisPlotAOIwTextChanged( wxCommandEvent& e )          { UpdateAnalysisPlotAOIParameter( m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas, -1, -1, e.GetInt() ); }
	void OnAnalysisPlotAOIxChanged( wxSpinEvent& e )                 { UpdateAnalysisPlotAOIParameter( m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas, e.GetPosition() ); }
	void OnAnalysisPlotAOIxTextChanged( wxCommandEvent& e )          { UpdateAnalysisPlotAOIParameter( m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas, e.GetInt() ); }
	void OnAnalysisPlotAOIyChanged( wxSpinEvent& e )                 { UpdateAnalysisPlotAOIParameter( m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas, -1, e.GetPosition() ); }
	void OnAnalysisPlotAOIyTextChanged( wxCommandEvent& e )          { UpdateAnalysisPlotAOIParameter( m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas, -1, e.GetInt() ); }
	void OnAnalysisPlot_PlotSelectionChanged( wxCommandEvent& e )    { m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas->SetPlotSelection( e.GetString() ); }
	void OnAnalysisPlotHistoryDepthChanged( wxSpinEvent& e )         { m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas->SetHistoryDepth( e.GetPosition() ); }
	void OnAnalysisPlotHistoryDepthTextChanged( wxCommandEvent& e )  { m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas->SetHistoryDepth( e.GetInt() ); }
	void OnAnalysisPlotDrawStartChanged( wxSpinEvent& e )            { m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas->SetDrawStartPercent( e.GetPosition() ); }
	void OnAnalysisPlotDrawStartTextChanged( wxCommandEvent& e )     { m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas->SetDrawStartPercent( e.GetInt() ); }
	void OnAnalysisPlotDrawWindowChanged( wxSpinEvent& e )           { m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas->SetDrawWindowWidthPercent( e.GetPosition() ); }
	void OnAnalysisPlotDrawWindowTextChanged( wxCommandEvent& e )    { m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas->SetDrawWindowWidthPercent( e.GetInt() ); }
	void OnAnalysisPlotDrawStepWidthChanged( wxSpinEvent& e )        { dynamic_cast<HistogramCanvas*>(m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas)->SetDrawStepWidth( e.GetPosition() ); }
	void OnAnalysisPlotDrawStepWidthTextChanged( wxCommandEvent& e ) { dynamic_cast<HistogramCanvas*>(m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas)->SetDrawStepWidth( e.GetInt() ); }
	void OnAnalysisPlotGridXStepsChanged( wxSpinEvent& e )           { UpdateAnalysisPlotGridSteps( m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas, e.GetPosition(), -1 ); }
	void OnAnalysisPlotGridXStepsTextChanged( wxCommandEvent& e )    { UpdateAnalysisPlotGridSteps( m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas, e.GetInt()     , -1 ); }
	void OnAnalysisPlotGridYStepsChanged( wxSpinEvent& e )           { UpdateAnalysisPlotGridSteps( m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas, -1, e.GetPosition() ); }
	void OnAnalysisPlotGridYStepsTextChanged( wxCommandEvent& e )    { UpdateAnalysisPlotGridSteps( m_ImageAnalysisPlots[GetAnalysisControlIndex( e.GetId() )].m_pPlotCanvas, -1, e.GetInt() ); }
	void OnAnalysisPlotUpdateSpeedChanged( wxSpinEvent& )            { AnalysisPlotUpdateSpeedChanged(); }
	void OnAnalysisPlotUpdateSpeedTextChanged( wxCommandEvent& )     { AnalysisPlotUpdateSpeedChanged(); }
	void OnFeatureChangedCallbackReceived( wxCommandEvent& e )       { WriteLogMessage( e.GetString() ); }
	...
	void OnInfoPlotUpdateHistoryDepthChanged( wxSpinEvent& e )        { m_pInfoPlotArea->SetHistoryDepth( e.GetPosition() ); }
	void OnInfoPlotUpdateHistoryDepthTextChanged( wxCommandEvent& e ) { m_pInfoPlotArea->SetHistoryDepth( e.GetInt() ); }
	void OnInfoPlotUpdateSpeedChanged( wxSpinEvent& e )               { m_pInfoPlotArea->SetUpdateFrequency( e.GetPosition() ); }
	void OnInfoPlotUpdateSpeedTextChanged( wxCommandEvent& e )        { m_pInfoPlotArea->SetUpdateFrequency( e.GetInt() ); }
	...
	void OnMonitorImageClosed( wxCommandEvent& ) { ConfigureMonitorImage( false ); }
	...
	virtual void OnPropertyChangedCustom( wxPropertyGridEvent& )      { m_pDevPropHandler->SetActiveDevice( GetSelectedDeviceSerial() ); }
	virtual void OnPropertyGridSelected( void );
	virtual void OnPropertyGridTimer( void );
	virtual void OnPropertyRightClickedCustom( wxPropertyGridEvent& ) { m_pDevPropHandler->SetActiveDevice( GetSelectedDeviceSerial() ); }
	virtual void OnPropertySelectedCustom( wxPropertyGridEvent& e )   { UpdateToolTipWindowAndWizardStatus( e.GetProperty() ); }
	...
	void OnSettings_AllowFastSingleFrameAcquisition( wxCommandEvent& ) { SetupDlgControls(); }
	...
	void OnSettings_PropGrid_UpdateViewMode( wxCommandEvent& ) { UpdatePropGridViewMode(); }
	...
	void OnWizards_FileAccessControl_UploadFile( wxCommandEvent& )   { Wizard_FileAccessControl( true ); }
	void OnWizards_FileAccessControl_DownloadFile( wxCommandEvent& ) { Wizard_FileAccessControl( false ); }
	void OnWizards_LUTControl( wxCommandEvent& ) { Wizard_LUTControl(); }
	void OnWizards_ColorCorrection( wxCommandEvent& ) { Wizard_ColorCorrection(); }
	...
	void OnShowStatusBar( wxCommandEvent& e )    { ConfigureStatusBar( e.IsChecked() ); }
	void OnShowLeftToolBar( wxCommandEvent& e )  { ConfigureToolBar( m_pLeftToolBar, e.IsChecked() ); m_pPanel->GetSizer()->Layout(); }
	void OnShowUpperToolBar( wxCommandEvent& e ) { ConfigureToolBar( m_pUpperToolBar, e.IsChecked() ); SendSizeEvent(); }
	...
	void OnToggleFullScreenMode( wxCommandEvent& e ) { ShowFullScreen( e.IsChecked() ); }
	void OnUpdateDeviceList( wxCommandEvent& ) { UpdateDeviceList(); }
	void OnUserExperienceComboTextChanged( wxCommandEvent& ) { UpdateUserExperience( m_pUserExperienceCombo->GetValue() ); }
	void SetupDlgControls( void );
	virtual bool ShowPropGridMethodExecutionErrors( void ) const { return m_pMISettings_PropGrid_ShowMethodExecutionErrors->IsChecked(); }
private:
	DECLARE_EVENT_TABLE()
	//-----------------------------------------------------------------------------
	enum TFileFormat
	...
	mvIMPACT::acquire::TDeviceInterfaceLayout m_defaultDeviceInterfaceLayout;
	...
	void								ConfigureToolBar( wxToolBar* pToolBar, bool boShow ) { boShow ? pToolBar->Show() : pToolBar->Hide(); }
	...
	int									GetAnalysisControlIndex( int windowID ) const { return ( windowID >> 8 ) - 1; }
	int									GetDesiredDeviceIndex( wxString& serial ) const;
	wxString							GetSelectedDeviceSerial( void ) const { return m_pDevCombo->GetValue().BeforeFirst( wxT(' ') ); }
