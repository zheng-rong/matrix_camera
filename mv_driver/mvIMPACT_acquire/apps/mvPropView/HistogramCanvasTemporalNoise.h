...
//-----------------------------------------------------------------------------
{
	...
	template<typename _Ty>
	void				CalculateTemporalNoiseHistogramUYV( const ImageBuffer* pIBNew, const ImageBuffer* pIBOld );
	template<typename _Ty>
	void				CalculateTemporalNoiseHistogramYUV( const ImageBuffer* pIBNew, const ImageBuffer* pIBOld );
	template<typename _Ty>
