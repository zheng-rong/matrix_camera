...
//-----------------------------------------------------------------------------
void WizardLensControl::CreateGUI( void )
//-----------------------------------------------------------------------------
{
    /*
        |-------------------------------------|
    ...
    */
    ...
    wxFlexGridSizer* pLensControlControlsSizer = new wxFlexGridSizer( 5, 0 );
    ...
    wxFlexGridSizer* pLensControlDriveLevelGridSizer = new wxFlexGridSizer( 3, 0 );
    ...
    wxFlexGridSizer* pLensControlVideoIrisGridSizer = new wxFlexGridSizer( 2, 0 );
