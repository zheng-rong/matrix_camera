...
//-----------------------------------------------------------------------------
{
	...
	{
	case ctPropInt:   value = static_cast<plot_datatype>(infoData.plotValue.value.intRep   ); break;
	case ctPropInt64: value = static_cast<plot_datatype>(infoData.plotValue.value.int64Rep ); break;
	case ctPropFloat: value = static_cast<plot_datatype>(infoData.plotValue.value.doubleRep); break;
	default:
		return;
	}
