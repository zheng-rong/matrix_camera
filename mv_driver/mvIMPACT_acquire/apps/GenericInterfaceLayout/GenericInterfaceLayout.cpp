...
//-----------------------------------------------------------------------------
void singleCapture( bool boMustStartAcquisition, const FunctionInterface& fi, ImageDisplayWindow* pDisp, int maxWaitTime_ms )
//-----------------------------------------------------------------------------
{
...
//-----------------------------------------------------------------------------
{
	...
	// Start the acquisition manually if this was requested(this is to prepare the driver for data capture and tell the device to start streaming data)
	const bool boMustStartAcquisition = pDev->acquisitionStartStopBehaviour.read() == assbUser;
#ifndef __linux__
