...
//-----------------------------------------------------------------------------
{
	...
	printf( "Hitcount: %d, hObj causing the callback: 0x%08x\n", ++hitCount, hObj );
	...
	{
		printf( "I got no more matches and not enough money to buy new ones...\n" );
	}
}
...
//-----------------------------------------------------------------------------
{
	...
	{
		printf( "The callback spend some of my money. I got %.2f left.\n", handbag.wallet_.euros_ );
	}
}
