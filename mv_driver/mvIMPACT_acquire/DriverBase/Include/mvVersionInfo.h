...
#define MVIMPACT_ACQUIRE_MINOR_VERSION   6
#define MVIMPACT_ACQUIRE_RELEASE_VERSION 3
#define MVIMPACT_ACQUIRE_BUILD_VERSION   1180
#define MVIMPACT_ACQUIRE_VERSION_STRING  "2.6.3.1180"
